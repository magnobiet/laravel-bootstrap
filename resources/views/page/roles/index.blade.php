                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <div class="btn-group" data-toggle="btn-toggle">
                            ...
                            <a href="{{ route('roles.create') }}" class="btn btn-sm bg-purple">
                                    ...
                                    @foreach ($roles as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('roles.show', [ 'id' => $value->id ]) }}" class="btn btn-default btn-xs" title="{{ __('Show') }}">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                    {{ __('Show') }}
                                                </a>

                                                <a href="{{ route('roles.edit', [ 'id' => $value->id ]) }}" class="btn btn-primary btn-xs" title="{{ __('Edit') }}">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    {{ __('Edit') }}
                                                </a>

                                                <form method="POST" action="{{ route('roles.destroy', [ 'id' => $value->id ]) }}" class="display-inline" role="form">
