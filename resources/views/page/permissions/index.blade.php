...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ __('Permissions') }}</li>
    </ol>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form method="GET" action="{{ route('permissions.index') }}" role="form">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <div class="btn-group" data-toggle="btn-toggle">
                            ...
                            <a href="{{ route('permissions.create') }}" class="btn btn-sm bg-purple">
                                    ...
                                    @foreach ($permissions as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('permissions.show', [ 'id' => $value->id ]) }}" class="btn btn-default btn-xs" title="{{ __('Show') }}">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                    {{ __('Show') }}
                                                </a>

                                                <a href="{{ route('permissions.edit', [ 'id' => $value->id ]) }}" class="btn btn-primary btn-xs" title="{{ __('Edit') }}">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    {{ __('Edit') }}
                                                </a>

                                                <form method="POST" action="{{ route('permissions.destroy', [ 'id' => $value->id ]) }}" class="display-inline" role="form">
